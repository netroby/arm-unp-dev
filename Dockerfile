...
RUN apt-get update -qq -y && \
    apt-get install -qq -y vim-nox php5-redis supervisor nginx php5-cli php5-fpm php5-mysqlnd php5-gd php5-curl php5-mcrypt curl mysql-client redis-server redis-tools 
