...
RUN dnf clean all && \
    ...
    dnf update -y && \
    dnf install -y procps-ng htop php-pecl-redis supervisor nginx php-cli php-fpm php-mysqlnd php-gd php-mbstring php-mcrypt curl mysql-community-client redis && \
    dnf clean all
